...
type AuthRequestRepository interface {
	...
	AutoRegisterExternalUser(ctx context.Context, user *domain.Human, externalUserID string, externalIDP *domain.UserIDPLink, orgMemberRoles []string, authReqID, userAgentID, resourceOwner string, metadatas []*domain.Metadata, info *domain.BrowserInfo) error
