...
func Setup(config *Config, steps *Steps, masterKey string) {
	...
	steps.s26UserSessionsAddExternalUserIDToLogout = &UserSessionsAddExternalUserIDToLogout{dbClient: esPusherDBClient}
	...
	for _, step := range []migration.Migration{
		...
		steps.s26UserSessionsAddExternalUserIDToLogout,
	} {
		mustExecuteMigration(ctx, eventstoreClient, step, "migration failed")
	}
