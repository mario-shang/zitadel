...
func startAPIs(
	...
	apis.RegisterHandlerOnPrefix(idp.HandlerPrefix, idp.NewHandler(commands, queries, authRepo, keys.IDPConfig, config.ExternalSecure, instanceInterceptor.Handler))
